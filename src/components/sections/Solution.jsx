  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(180deg, #0a0a0a 0%, #0f1f0a 50%, #0a0a0a 100%)',
        }}
      />
      ...
      <Container className="relative z-10">
        ...
        <ScrollReveal className="text-center mb-16">
          <h2 className="text-fluid-3xl md:text-fluid-4xl font-bold mb-6">
            La Logica del{' '}
            <span className="text-accent-lime text-shadow-glow">Revenue Share</span>
          </h2>
        ...
        <ScrollReveal delay={0.2}>
          <div className="relative max-w-4xl mx-auto">
            {/* Connecting line */}
            <motion.div
              className="absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-accent-lime/20 via-accent-lime to-accent-lime/20 -translate-y-1/2 hidden md:block"
              initial={{ scaleX: 0 }}
        ...
        <ScrollReveal delay={0.4} className="text-center mt-16">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-accent-lime/10 border border-accent-lime/20">
            <span className="text-accent-lime font-semibold">Risultato</span>
